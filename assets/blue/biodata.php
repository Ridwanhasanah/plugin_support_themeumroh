...
<title>Resume</title>
<style type="text/css">
  <?php require_once('css/blue.php');?>
</style>
</head>
<body>
<?php include(plugin_dir_path(__FILE__) . '../../Model/dbconnect.php'); ?>
      ...
      <div id="paper-mid">
        <div class="entry">
          ...
          <?php
           ...
           print_r(get_home_url().$pagenow.'?page=single-'.$id2); 

           echo '<br>'.$pagenow;?>
          <!-- End Image -->
          <!-- Begin Personal Information -->
          <div class="self">
            <h1 class="name"><?= $dbid[0]->full_name?><br /><br>
              <span><?= $dbid[0]->name_service;?></span></h1>
            <ul>
              <li class="ad">&nbsp;&nbsp;&nbsp;<?= $dbid[0]->home_add;?></li>
              <li class="mail">&nbsp;&nbsp;&nbsp;<?= $dbid[0]->email;?></li>
              <li class="tel">&nbsp;&nbsp;&nbsp;<?= $dbid[0]->hp;?></li>
          ...
          <div class="social">
            <ul>
              <li><a class='north' href="#" title="Download .pdf">
                <img src="<?= plugins_url( 'images/icn-save.jpg', __FILE__ );?>" alt="Download the pdf version" /></a>
              </li>
              <li>
                <a class='north' id="ins" href="contact/index.html" title="Contact Me">
                  <img src="<?= plugins_url( 'images/icn-ins.png', __FILE__ );?>" alt="" />
                </a>
              </li>
              <li>
                <a class='north' href="#" title="Follow me on Twitter">
                  <img src="<?= plugins_url('images/icn-twitter.jpg',__FILE__);?>" alt="" />
                </a>
              </li>
              <li>
                 <a class='north' href="#" title="My Facebook Profile">
                  <img src="<?= plugins_url( 'images/icn-facebook.jpg', __FILE__ );?>" alt="" />
                </a>
              </li>
            </ul>
          </div>
